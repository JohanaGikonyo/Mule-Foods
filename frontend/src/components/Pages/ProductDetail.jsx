...
function ProductDetail() {
    ...
    return (
        <div>
            <div className="flex flex-col lg:flex-row items-center  bg-slate-50 p-2 rounded-md">
                <div className="relative">
                    <img src={product.image} alt="" className=" w-60 h-60 rounded-md m-10" />
                    <p className="bg-orange-400 text-white absolute rounded p-1 bottom-[20%] left-0">{product.discount}</p>
                </div>
                <div className="flex flex-col gap-10 m-10">
                    ...
                    <div> <button className="px-2 py-1 bg-stone-300 rounded-md text-white font-semibold">Add {count} for ${product.price * count}</button> <Button>Order</Button></div>
