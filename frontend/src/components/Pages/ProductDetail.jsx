...
function ProductDetail() {
    ...
    const handleAddItemToCart = () => {
        if (amount > 0) {
            addItems({
                ...
                itemPrice: product.itemPrice, // Store individual item price as well
    ...
    return (
        <div className="flex justify-around items-center">
            <div className="flex flex-col lg:flex-row relative items-center bg-slate-100 p-2 shadow-md shadow-neutral-500 rounded-md">
                <div className="absolute right-[10%] top-5 z-30">
                    <button onClick={() => { setProductDetailVisible() }} className="text-orange-400">
                        <CloseIcon />
                    </button>
                </div>
