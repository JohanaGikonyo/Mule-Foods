    ...
    return (
        <div className="flex flex-col items-center justify-center mt-10 m-4">
            <div className="max-w-md mx-auto p-8 bg-white shadow-md rounded-md text-center">
                ...
                <p className="text-gray-600 mb-4">It will be delivered to <span className="text-blue-500">{name} at {location}</span> in one  hour.</p>
                <p className="text-gray-600 mb-4">Thank You</p>
                <button className="bg-blue-500 text-white py-2 px-6 rounded-md mb-4 mr-4"><NavLink to='/mainpage/account'>Change Location</NavLink></button>
